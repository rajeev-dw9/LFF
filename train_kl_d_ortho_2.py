...
#--------------------------------------------------------------------------------------------#
        ...
        loss = loss_b_update.mean() + loss_d_update.mean() + lambda_ortho* loss_kl_1
#--------------------------------------------------------------------------------------------#
    ...
    model_b_file_name = f"model_f_kl_{lambda_ortho}_b__2.th"
    model_d_file_name = f"model_f_kl_{lambda_ortho}_d__2.th"
