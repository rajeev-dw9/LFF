...
def train(
    ...
    model_b,feat_b = get_model(model_tag, attr_dims[0])
    model_d, feat_d = get_model(model_tag, attr_dims[0])
...
#--------------------------------------------------------------------------------------------#
    ...
    model_b_file_name = f"model_f_kl__b__0___ortho.th"
    model_d_file_name = f"model_f_kl__d__0___ortho.th"
