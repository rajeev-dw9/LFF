...
def train(
    ...
    for step in tqdm(range(main_num_steps)):
        ...
        loss_kl_3 = 1 - kl_loss(layer3_b.softmax(1),layer3_d.softmax(1))
...
#--------------------------------------------------------------------------------------------#
    ...
    model_b_file_name = f"model_f_kl_{lambda_ortho}_b__024.th"
    model_d_file_name = f"model_f_kl_{lambda_ortho}_d__024.th"
