...
#--------------------------------------------------------------------------------------------#
        layer_names_2 = ['layer4.1.conv2.weight']
        layer_names_4 = ['layer1.1.conv2.weight']
        ...
        ortho_loss = ortho_loss_4 - ortho_loss_2
...
#--------------------------------------------------------------------------------------------#
    ...
    result_file_name = f"mnist_result_cosine__{lambda_ortho}__nl1nl2pl4___Resnet.th"
    model_file_name = f"mnist_model_cosine__{lambda_ortho}__nl1nl2pl4___Resnet.th"
