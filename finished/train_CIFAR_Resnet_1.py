...
#--------------------------------------------------------------------------------------------#
        layer_names_2 = ['layer1.1.conv2.weight']
        layer_names_4 = ['layer2.1.conv2.weight']
        ...
        ortho_loss = ortho_loss_2.mean() - ortho_loss_4.mean()
...
#--------------------------------------------------------------------------------------------#
    ...
    result_file_name = f"mnist_result_cosine__{lambda_ortho}__pl2nl4___Resnet.th"
    model_file_name = f"mnist_model_cosine__{lambda_ortho}__pl2nl4___Resnet.th"
