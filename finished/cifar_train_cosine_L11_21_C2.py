...
#--------------------------------------------------------------------------------------------#
        ...
        ortho_loss = calculate_cosine_similarity_loss(model_b, model_d, layer_names)
...
#--------------------------------------------------------------------------------------------#
    ...
    result_file_name = f"cifar_result_cosine__{lambda_ortho}__L11_21_C2.th"
    model_file_name = f"cifar_model_cosine__{lambda_ortho}__L11_21_C2.th"
