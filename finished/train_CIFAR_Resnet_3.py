...
#--------------------------------------------------------------------------------------------#
        layer_names_2 = ['layer3.1.conv2.weight']
        layer_names_4 = ['layer4.1.conv2.weight']
...
#--------------------------------------------------------------------------------------------#
    ...
    result_file_name = f"mnist_result_cosine__{lambda_ortho}__nl2pl4___Resnet.th"
    model_file_name = f"mnist_model_cosine__{lambda_ortho}__nl2pl4___Resnet.th"
