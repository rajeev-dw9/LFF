...
#--------------------------------------------------------------------------------------------#
        ...
        layer_names = ['feature.0.weight','feature.2.weight','feature.4.weight']
...
#--------------------------------------------------------------------------------------------#
    ...
    result_file_name = f"result_cosine__neg__{lambda_ortho}__024.th"
    model_file_name = f"model_cosine__neg__{lambda_ortho}__024.th"
