...
#--------------------------------------------------------------------------------------------#
        ...
        # loss = loss_b_update.mean() + loss_d_update.mean()# + (lambda_ortho / 2) * ortho_loss
        loss = loss_b_update.mean() + loss_d_update.mean() + 0.01* loss_kl_1 #+ loss_kl_2 + loss_kl_3
#--------------------------------------------------------------------------------------------#
    ...
    model_b_file_name = "model_f_kl_{lambda_ortho}_b__.th"
    model_d_file_name = "model_f_kl_{lambda_ortho}_d__.th"
