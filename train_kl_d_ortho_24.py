...
#--------------------------------------------------------------------------------------------#
    ...
    model_b_file_name = f"model_f_kl_{lambda_ortho}_b__24.th"
    model_d_file_name = f"model_f_kl_{lambda_ortho}_d__24.th"
