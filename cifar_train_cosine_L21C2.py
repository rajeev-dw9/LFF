...
#--------------------------------------------------------------------------------------------#
        ...
        layer_names = ["layer2.1.conv2.weight"]
...
#--------------------------------------------------------------------------------------------#
    ...
    result_file_name = f"cifar_result_cosine__{lambda_ortho}__L21C2.th"
    model_file_name = f"cifar_model_cosine__{lambda_ortho}__L21C2.th"
