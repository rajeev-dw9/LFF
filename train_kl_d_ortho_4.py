...
#--------------------------------------------------------------------------------------------#
    ...
    model_b_file_name = f"model_f_kl_{lambda_ortho}_b__4.th"
    model_d_file_name = f"model_f_kl_{lambda_ortho}_d__4.th"
